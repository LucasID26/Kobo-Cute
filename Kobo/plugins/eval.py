...
@bot.on_edited_message(filters.command("sh","") & filters.user(own))
...
@bot.on_message(filters.command("run","") & filters.user(own))
@bot.on_edited_message(filters.command("run","") & filters.user(own))
